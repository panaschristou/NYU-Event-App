...
class UserRegistrationFormTest(TestCase):
    ...
    def test_email_validation(self):
        ...
        self.assertIn('email', form.errors)  # The form should have an error associated with 'email'
    ...
    def test_password_mismatch(self):
        ...
        form = UserRegistrationForm(data=form_data)
        self.assertFalse(form.is_valid())
        self.assertIn('password2', form.errors)  # Error should be associated with 'password2'
    ...
    def test_missing_fields(self):
        ...
        form = UserRegistrationForm(data=form_data)
        self.assertFalse(form.is_valid())
        self.assertIn('username', form.errors)  # Error should be associated with 'username'
