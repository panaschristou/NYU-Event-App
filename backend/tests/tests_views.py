...
class EventViewsTestCase(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create_user(username='testuser@nyu.edu', password='12345Password!')
    ...
    def test_login_user_view(self):
        ...
        response = self.client.post(reverse('login'), {'username': 'testuser@nyu.edu', 'password': '12345Password!'})
